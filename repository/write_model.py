...
def branch_soft_del(branch_id: int,
                    con:Connection)->None:
    cur = con.cursor()
...
def branch_activate(branch_id:int,
                    con:Connection)->None:
    cur = con.cursor()
...
#USERS
def user_assert(con: Connection,
                user_name: str,
                api_user_id: int,
                role_id: int,
...
def user_activate(user_id: int,con:Connection)->None:
    cur = con.cursor()
...
def update_user_params(user_id:int,
                       role_id:int,
                       branch_id:int,
                       depart_id:int,
                       con:Connection)->None:
...
#HISTORY
def insert_history_record(ticket_id:int,
                          timestamp:str,
                          user_id:int,
                          field:str|int,
                          old:str|int|None,
